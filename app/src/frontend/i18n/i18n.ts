...
const resources = {
  ...
  es: {
    translation: {
      ...
      "Are you sure you want to deletose your account? This cannot be undone.":"¿Estás seguro de que quieres eliminar tu cuenta? Esto no se puede deshacer",
      ...
      "Unclassified, presumed non-residential":"No clasificado, presuntamente no residencial",
      "Detached":"Adosada",
      ...
      "All data relating to designated buildings should be checked on the National Heritage List for England or local authority websites where used for planning or development purposes":"Todos los datos relativos a los edificios designados deben comprobarse en la Lista del Patrimonio Nacional o en los sitios web de las autoridades locales cuando se utilicen con fines de planificación o desarrollo",
      ...
      "Demolished buildings on the same site":"Edificios demolidos en el mismo lugar",
      "None":"Ninguno",
      "Like Me":"Como yo",
      ...
      "People who think the building should be locally listed":"Las personas piensan que el edificio debería ser catalogado localmente",
