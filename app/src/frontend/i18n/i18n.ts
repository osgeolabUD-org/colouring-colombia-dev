...
const resources = {
  ...
  es: {
    translation: {
      ...
      "Latest possible start year": "Último año posible de inicio",
      "Facade year": "Fecha de modificación de fachada",
      ...
      "Building information (link)":"Información de Construcción (link)",
      "Building number":"Número del Edificio",
      "Street":"Calle",
      "Address line 2": "Segunda dirección",
      "Town":"Ciudad",
      "Postcode":"Código Postal",
      "Latitude":"Latitud",
      "Longitude":"Longitud",
      "Core Material":"Material Principal",
      "Main Secondary Construction Material/s":"Materiales de construcción principales y/o secundario/s",
      ...
      "Longitude, e.g. -0.0586":"Longitud, e.g. -0.0586",
      "Latitude, e.g. 51.5467":"Latitud, e.g. 51.5467",
      ...
      "Is the building proposed for demolition?":"¿Sé propone la demolición del edificio?",
      "Has this application recently been been approved/refused?": "¿Esta solicitud ha sido aprobada/rechazada recientemente?",
      "Has the work been carried out?":"¿Sé han realizado las obras?",
      ...
      "Greater London Historic Environment Record link":"Enlace al Registro de Bogotá",
      "In the Greater London Historic Environment Record?":"¿En el Registro de Bogotá?",
      ...
      "Is there an extension?":'¿Hay una extensión?',
      "What type of developer built the building?":'¿Qué tipo de Desarrollador construyó el edificio?',
      "Who were the developer(s)?":'¿Quiénes fueron los Desarrolladores?',
      ...
      "Who were the main designer(s)?":'¿Quiénes fueron los principales diseñadores?',
      "Source links for designer(s)":'Enlace fuente acerca de los diseñadores',
      "Which best describes the lead designer?":'¿Qué describe mejor al diseñador principal?',
      "Did the design team win any awards for this building?":'¿Ganó el equipo de diseño algún premio por el edificio?',
      ...
      "Source builder/ construction team":'Fuentes acerca de la constructora/equipo de construcción',
      "This section is under development as part of the project CLPV Tool. For more details and progress":"Esta sección está en desarrollo como parte del proyecto CLPV Tool. Para más detalles y progresos, ",
      "Planning portal link":"Enlace al portal de planificación",
      ...
      "Storeys": "Pisos",
      "Height": "Altura",
      "Total opening area": "Área total de bienvenida",
      ...
      "Can you help us capture information on who built the current building?":"¿Puede ayudarnos a obtener información sobre quién construyó el edificio actual?",
      "About":"Sobre",
